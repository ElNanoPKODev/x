...
CResourceBundleManage::CResourceBundleManage(const char* configFileName) : m_ResDir(0), m_ResLocale(0), m_pResourceBundle(0), m_pConverter(0), m_MaxSize(0), m_LogFile(0), m_LogFlag(0)
{
